                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('class/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('class/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li>
						<li>
						...
						<li>
                            <a href="#">
                                <i class="fa fa-address-card-o"></i> <span>Permision</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('permision/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('permision/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li>
						<li>
                            ...
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('profile/add');?>"><i class="fa fa-plus"></i> Add</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('profile/index');?>"><i class="fa fa-list-ul"></i> Listing</a>
                                </li>
							</ul>
                        </li>
						<li>
